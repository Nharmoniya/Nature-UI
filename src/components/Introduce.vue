<template>
  <article class="markdown-body">
    <h1>介绍</h1>
    <p><code>Nature-UI</code>是一个以<span class="theme-green">绿色</span>为主题的UI组件库。</p>
    <p>基于<code>Vue3</code>的最新语法和<code>Typescript</code>以及<code>SCSS</code>。</p>
    <p>全程不使用任何第三方组件库，略微参考个别组件库的UI风格。</p>
